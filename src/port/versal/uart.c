 ...
 *
 * Register reference: ARM PL011 (PrimeCell SP804 / SP805 family
 * UART), DDI 0183. The Versal versal.dtsi maps PL011 base addresses
 * to 0xFF000000 (UART0) and 0xFF010000 (UART1).
 *
...
#define UART_IMSC   (*(volatile uint32_t *)(UART0_BASE + 0x038))  /* irq mask */
#define UART_ICR    (*(volatile uint32_t *)(UART0_BASE + 0x044))  /* irq clr */
