 ...
 *
 * TI DP83867IR PHY init for the ZCU102 (PHY on RGMII to PS-GEM3).
 *
 * The DP83867 needs explicit RGMII TX and RX clock delay configuration
 * (CFG4 / RGMIICTL extended registers) because the ZCU102 routes
 ...
 * 0x8 -> 2.0 ns (matches Linux/Xilinx default for ZCU102). */
...
int dp83867_init(uint8_t phy_addr, int *speed_out, int *full_duplex_out)
{
     ...
     */
    {
        ...
        /* 1. RX_CTRL strap quirk for ZCU102. */
