 ...
 * Socket buffers: 4 sockets * (3072 + 3072) = 24,576 bytes
 * DMA buffers: 6 * 1536 + 1536 staging = 10,752 bytes
 * Stack: ~4KB, misc: ~2KB
 * Total estimated: ~41KB (fits in 64KB with margin)
 */
#define MAX_TCPSOCKETS          2    /* listen + 1 client */
#define MAX_UDPSOCKETS          1    /* for DHCP */
#define MAX_ICMPSOCKETS         1
#define RXBUF_SIZE              (LINK_MTU * 2)   /* 3072 per socket */
#define TXBUF_SIZE              (LINK_MTU * 2)   /* 3072 per socket */
