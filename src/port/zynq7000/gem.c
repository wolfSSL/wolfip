 ...
 *
 * Cadence GEM driver for Zynq-7000 GEM0 (on-board RJ45 typical).
 *
 * - 32-bit DMA addressing (OCM low bank or DDR, both < 4 GB).
 * - IRQ-driven RX via GIC INTID 54 (board.h IRQ_GEM0) -> gem_isr;
 *   polled TX. The register layout matches ZynqMP's GEM3 except
 *   Zynq-7000 has an older GEM revision with 32-bit BDs by default
 *   (no DMACR DMA_ADDR_BUS_WIDTH_64 bit needed -- BDs stay 8 bytes).
 *   The NWCFG.DBUS_WIDTH_64 bit is unused on Zynq-7000 (the PS bus
 *   width is fixed at 32 bits for the A9 AXI master path); the
 *   constant is kept for source-compatibility but never set.
 *
 * Register set per Zynq-7000 TRM (UG585) chapter 16 / Cadence GEM.
 *
 ...
 * ------------------------------------------------------------------- */
#define GEM_NWCTRL          (*(volatile uint32_t *)(GEM0_BASE + 0x000))
#define GEM_NWCFG           (*(volatile uint32_t *)(GEM0_BASE + 0x004))
#define GEM_NWSR            (*(volatile uint32_t *)(GEM0_BASE + 0x008))
#define GEM_DMACR           (*(volatile uint32_t *)(GEM0_BASE + 0x010))
#define GEM_TSR             (*(volatile uint32_t *)(GEM0_BASE + 0x014))
#define GEM_RXQBASE         (*(volatile uint32_t *)(GEM0_BASE + 0x018))
#define GEM_TXQBASE         (*(volatile uint32_t *)(GEM0_BASE + 0x01C))
#define GEM_RSR             (*(volatile uint32_t *)(GEM0_BASE + 0x020))
#define GEM_ISR             (*(volatile uint32_t *)(GEM0_BASE + 0x024))
#define GEM_IER             (*(volatile uint32_t *)(GEM0_BASE + 0x028))
#define GEM_IDR             (*(volatile uint32_t *)(GEM0_BASE + 0x02C))
#define GEM_PHYMNTNC        (*(volatile uint32_t *)(GEM0_BASE + 0x034))
#define GEM_HASHL           (*(volatile uint32_t *)(GEM0_BASE + 0x080))
#define GEM_HASHH           (*(volatile uint32_t *)(GEM0_BASE + 0x084))
#define GEM_LADDR1L         (*(volatile uint32_t *)(GEM0_BASE + 0x088))
#define GEM_LADDR1H         (*(volatile uint32_t *)(GEM0_BASE + 0x08C))
...
#define GEM_TXQ1BASE        (*(volatile uint32_t *)(GEM0_BASE + 0x440))
#define GEM_TXQ2BASE        (*(volatile uint32_t *)(GEM0_BASE + 0x444))
#define GEM_TXQ3BASE        (*(volatile uint32_t *)(GEM0_BASE + 0x448))
#define GEM_RXQ1BASE        (*(volatile uint32_t *)(GEM0_BASE + 0x480))
#define GEM_RXQ2BASE        (*(volatile uint32_t *)(GEM0_BASE + 0x484))
#define GEM_RXQ3BASE        (*(volatile uint32_t *)(GEM0_BASE + 0x488))
#define GEM_OCTTXL          (*(volatile uint32_t *)(GEM0_BASE + 0x100))
#define GEM_TXCNT           (*(volatile uint32_t *)(GEM0_BASE + 0x108))
#define GEM_OCTRXL          (*(volatile uint32_t *)(GEM0_BASE + 0x150))
#define GEM_RXCNT           (*(volatile uint32_t *)(GEM0_BASE + 0x158))
#define GEM_RXFCSCNT        (*(volatile uint32_t *)(GEM0_BASE + 0x190))
#define GEM_RXORCNT         (*(volatile uint32_t *)(GEM0_BASE + 0x1A4))
...
static int eth_poll(struct wolfIP_ll_dev *ll, void *buf, uint32_t len)
{
     ...
     * board.h IRQ_GEM0). eth_poll just drains the SW queue here. */
    tail = swq_tail;
    if (tail == swq_head)
...
void gem_dump_state(void)
{
    ...
    uart_puts(" IMR=");             uart_puthex(*(volatile uint32_t *)(GEM0_BASE + 0x030));
...
{
    volatile uint32_t *gem3_ref = (volatile uint32_t *)SLCR_GEM0_CLK_CTRL;
    uint32_t div1;
    uint32_t val;
...
static void gem3_hw_reset(void)
{
    ...
    volatile uint32_t *gem3ref = (volatile uint32_t *)SLCR_GEM0_CLK_CTRL;
...
int zcu102_eth_init(struct wolfIP_ll_dev *ll)
{
     ...
     * queues. Default 0 = all to Q0. */
    {
        uint32_t k;
        for (k = 0; k < 16; k++) {
            *(volatile uint32_t *)(GEM0_BASE + 0x500 + 4*k) = 0;
            *(volatile uint32_t *)(GEM0_BASE + 0x540 + 4*k) = 0;
        }
    }
    ...
    /* Install RX ISR. */
    gic_register_handler(IRQ_GEM0, gem_isr);
    gic_enable_spi(IRQ_GEM0, 0xA0);
