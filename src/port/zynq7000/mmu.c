 ...
 *                            which is Normal cacheable executable.
 *
 ...
 * and Device-nGnRnE (TEX=000, C=0, B=0) per ARMv7-A short descriptor.
 *
...
static void mmu_build_tables(void)
{
     ...
     * The section at 0xFFF00000 (1 MB) covers it. Mark Normal-WB and
     * executable so code can run from OCM after MMU enable. */
    L1[0xFFF] = SEC_NORMAL_WB(0xFFF00000u);
}
