...
#define SVC_HANDLER_REF      SVC_Handler
#define PENDSV_HANDLER_REF   PendSV_Handler
#define SYSTICK_HANDLER_REF  SysTick_Handler
#else
...
const uint32_t vector_table[16 + 96] = {
    ...
    [7] = 0, [8] = 0, [9] = 0, [10] = 0,
    [11] = (uint32_t)&SVC_HANDLER_REF,
    [12] = (uint32_t)&DebugMon_Handler,
    [13] = 0,
    [14] = (uint32_t)&PENDSV_HANDLER_REF,
    [15] = (uint32_t)&SYSTICK_HANDLER_REF,
