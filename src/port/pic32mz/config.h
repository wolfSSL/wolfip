/* config.h
 *
 * wolfIP configuration for the PIC32MZ EF port.
 *
...
/* PIC32MZ EF has 512 KB SRAM, so the profile is roomier than the tiny ports. */
#define MAX_TCPSOCKETS          4
#define MAX_UDPSOCKETS          2    /* DHCP + 1 app */
#define MAX_ICMPSOCKETS         1
#define RXBUF_SIZE              (4 * LINK_MTU)
#define TXBUF_SIZE              (4 * LINK_MTU)
