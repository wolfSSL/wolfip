...
Suite *wolf_suite(void)
{
    ...
    tcase_add_test(tc_wolfcert, test_wolfcert_io_connect_waits_until_writable);
    tcase_add_test(tc_wolfcert, test_wolfcert_io_connect_deadline_closes_socket);
    tcase_add_test(tc_wolfcert, test_wolfcert_io_connect_reset_is_not_rearmed);
    tcase_add_test(tc_wolfcert, test_wolfcert_io_connect_reused_slot_is_left_alone);
    ...
    tcase_add_test(tc_wolfcert, test_wolfcert_io_disconnect_leaves_fin_to_stack);
    ...
    tcase_add_test(tc_core, test_dhcp_schedule_lease_timer_defaults_fuzzed);
    ...
    tcase_add_test(tc_core, test_dns_callback_truncated_answer_delivered);
